...
gene-versus-molecule pass/fail decision in `p2$cellMeta`. This inspection step
is optional: `p2$run()` will call it if the metrics are missing.
...
```{r marker-heatmap, fig.width=13.5, fig.height=8.1}
p2$plotMarkerHeatmap(
  engine = "native",
  n.genes.per.group = 3,
