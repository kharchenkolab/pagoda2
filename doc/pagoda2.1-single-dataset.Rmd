...
component; the gray curve shows the cumulative amount explained.
...
```{r marker-dotplot, fig.width=15, fig.height=9}
p2$plotMarkerDotPlot(n.genes.per.group = 3, dot.scale = 5, text.angle = 60) +
...
```{r marker-heatmap, fig.width=15, fig.height=9}
