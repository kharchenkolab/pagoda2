...
colMeanVarView <- function(sY, rowSel, depth, depthScale, normalize, logScale, batch, batchFactors, winsorCaps, preWinsorDepth, postWinsorDepth, model = 0L, clrDivisor, idf, ncores = 1L) {
    .Call('_pagoda2_colMeanVarView', PACKAGE = 'pagoda2', sY, rowSel, depth, depthScale, normalize, logScale, batch, batchFactors, winsorCaps, preWinsorDepth, postWinsorDepth, model, clrDivisor, idf, ncores)
}
...
colSumByFacView <- function(sY, rowSel, depth, depthScale, normalize, logScale, batch, batchFactors, winsorCaps, preWinsorDepth, postWinsorDepth, model = 0L, clrDivisor, idf, ncores = 1L) {
    .Call('_pagoda2_colSumByFacView', PACKAGE = 'pagoda2', sY, rowSel, depth, depthScale, normalize, logScale, batch, batchFactors, winsorCaps, preWinsorDepth, postWinsorDepth, model, clrDivisor, idf, ncores)
}
