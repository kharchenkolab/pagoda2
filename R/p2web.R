  ...
  pagoda2WebApp <- setRefClass(
      ...
      methods = list(
          ...
          serializeToStaticFast = function(...) {
            warning("serializeToStaticFast() is deprecated please use serializeToStatic");
            serializeToStatic(...);
          },

          serializeToStatic = function(binary.filename=NULL,verbose=FALSE){
              ...
              # Export all contained embeddings to List
